...
import com.eliorcohen12345.locationproject.PagesPackage.MapSearchFragment;
...
public class CustomAdapterAdapterSearch extends RecyclerView.Adapter<CustomAdapterAdapterSearch.PlaceViewHolder> {
    ...
    public CustomAdapterAdapterSearch(Context context) {
        mInflater = LayoutInflater.from(context);
    }

    @Override
    public PlaceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.apapter_place, parent, false);
